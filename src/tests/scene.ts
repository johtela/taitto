...
export class Scene {
    ...
    get addLitsConfig() {
        return new anim.AnimSequence()
            ...
            .addToEnd([anim.zoomIn(this.inputFiles[3], 1000),
                anim.fadeIn(this.inputFiles[3])], 1000)
            .addToEnd(this.nextAnim)
    }
    ...
    get openTerminal() {
        return new anim.AnimSequence()
            ...
            .addToEnd([anim.slideInTop(this.term, 4, 1000),
    ...
    get processFiles() {
        ...
        return new anim.AnimSequence()
            ...
            .addToEnd(this.changeCaption(
                ...
                "converts them to HTML, and creates a web site for your " + 
                "project in the output folder.", 50, 250))
            .addToEnd(this.nextAnim)
    }
}